...
env_path = os.path.join(BASE_DIR, '.env_dev')
...
#         'HOST': os.getenv('PG_HOST'),  # Имя сервиса контейнера PostgreSQL из docker-compose.yml
...
#         'LOCATION': 'redis://redis:6379/1',  # Имя сервиса контейнера Redis из docker-compose.yml
#         'OPTIONS': {
